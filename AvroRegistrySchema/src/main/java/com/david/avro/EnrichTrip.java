...
public class EnrichTrip extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2779074039659074714L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EnrichTrip\",\"namespace\":\"com.david.avro\",\"fields\":[{\"name\":\"stationInformation\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"StationInformation\",\"fields\":[{\"name\":\"stationId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"externalId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"shortName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lat\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lon\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"rentalMethods0\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"rentalMethods1\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"capacity\",\"type\":\"int\"},{\"name\":\"eightdHasKeyDispenser\",\"type\":\"boolean\"},{\"name\":\"hasKiosk\",\"type\":\"boolean\"},{\"name\":\"googleApiGeocodingJson\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}}},{\"name\":\"tripHistory\",\"type\":{\"type\":\"record\",\"name\":\"TripHistory\",\"fields\":[{\"name\":\"start_date\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"start_station_code\",\"type\":\"int\"},{\"name\":\"end_date\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"end_station_code\",\"type\":\"int\"},{\"name\":\"duration_sec\",\"type\":\"int\"},{\"name\":\"is_member\",\"type\":\"int\"}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<EnrichTrip> ENCODER =
      new BinaryMessageEncoder<EnrichTrip>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<EnrichTrip> DECODER =
      new BinaryMessageDecoder<EnrichTrip>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<EnrichTrip> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<EnrichTrip> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<EnrichTrip>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this EnrichTrip to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a EnrichTrip from a ByteBuffer. */
  public static EnrichTrip fromByteBuffer(
   ...
   */
  public EnrichTrip(java.util.List<com.david.avro.StationInformation> stationInformation, com.david.avro.TripHistory tripHistory) {
  ...
  /**
   * Creates a new EnrichTrip RecordBuilder.
   * @return A new EnrichTrip RecordBuilder
   */
  public static com.david.avro.EnrichTrip.Builder newBuilder() {
    return new com.david.avro.EnrichTrip.Builder();
  }

  /**
   * Creates a new EnrichTrip RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new EnrichTrip RecordBuilder
   */
  public static com.david.avro.EnrichTrip.Builder newBuilder(com.david.avro.EnrichTrip.Builder other) {
    return new com.david.avro.EnrichTrip.Builder(other);
  }

  /**
   * Creates a new EnrichTrip RecordBuilder by copying an existing EnrichTrip instance.
   * @param other The existing instance to copy.
   * @return A new EnrichTrip RecordBuilder
   */
  public static com.david.avro.EnrichTrip.Builder newBuilder(com.david.avro.EnrichTrip other) {
    return new com.david.avro.EnrichTrip.Builder(other);
  }

  /**
   * RecordBuilder for EnrichTrip instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EnrichTrip>
    implements org.apache.avro.data.RecordBuilder<EnrichTrip> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.david.avro.EnrichTrip.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing EnrichTrip instance
     * @param other The existing instance to copy.
     */
    private Builder(com.david.avro.EnrichTrip other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.stationInformation)) {
        this.stationInformation = data().deepCopy(fields()[0].schema(), other.stationInformation);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.david.avro.EnrichTrip.Builder setStationInformation(java.util.List<com.david.avro.StationInformation> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.david.avro.EnrichTrip.Builder clearStationInformation() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.david.avro.EnrichTrip.Builder setTripHistory(com.david.avro.TripHistory value) {
     ...
     * @return This builder.
     */
    public com.david.avro.EnrichTrip.Builder setTripHistoryBuilder(com.david.avro.TripHistory.Builder value) {
      clearTripHistory();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.david.avro.EnrichTrip.Builder clearTripHistory() {
      tripHistory = null;
    ...
    public EnrichTrip build() {
      try {
        EnrichTrip record = new EnrichTrip();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<EnrichTrip>
    WRITER$ = (org.apache.avro.io.DatumWriter<EnrichTrip>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<EnrichTrip>
    READER$ = (org.apache.avro.io.DatumReader<EnrichTrip>)MODEL$.createDatumReader(SCHEMA$);
