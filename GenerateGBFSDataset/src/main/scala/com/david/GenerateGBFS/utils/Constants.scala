...
object Constants {
  ...
  val HDFS_STATION_STATUS = "hdfs://localhost:9000/user/vagrant/bixi/gbfs/staging/feed/station_status"
  val HDFS_SYSTEM_ALERTS = "hdfs://localhost:9000/user/vagrant/bixi/gbfs/staging/feed/system_alerts"
  val HDFS_SYSTEM_INFORMATION = "hdfs://localhost:9000/user/vagrant/bixi/gbfs/staging/feed/system_information"
  val HDFS_STATION_INFORMATION = "hdfs://localhost:9000/user/vagrant/bixi/gbfs/staging/feed/station_information"
  ...
  val SYSTEM_ALERTS_COLUMNS = Seq("alert_id", "type", "summary", "description", "last_updated")
